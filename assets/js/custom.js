        ...
        jQuery('#comments-form').validate({
            ...
            messages: {
                name: {
                    ...
                    minlength: jQuery.format("Cel putin {0} caractere necesare.")
                },
                email: {
                    required: "Va rugam introduceti e-mail.",
                    email: "Va rugam introduceti e-mail."
                },
                url: {
                    required: "Va rugam introduceti website.",
                    url: "Va rugam introduceti website."
                },
                message: {
                    required: "Va rugam introduceti mesaj.",
                    minlength: jQuery.format("Cel putin {0} caractere necesare.")
                },
                subject: {
                    required: "Va rugam selectati subiect.",
                    subject: "Va rugam selectati subiect."
                }
            },
		
            // Use Ajax to send everything to processForm.php
            submitHandler: function(form) {
                jQuery("#submit-comment").attr("value", "Se trimite...");
    ...
    if(jQuery("#contact-form").length > 0){
        ...
        jQuery('#contact-form').validate({
            ...
            rules: {
                ...
                subject: { valueNotEquals: "default" }
            },
            ...
            messages: {
                ...
                subject: { valueNotEquals: "Please select an item!" }
            },
		
            // Use Ajax to send everything to processForm.php
            submitHandler: function(form) {
                jQuery("#submit-contact").attr("value", "Se trimite...");
                jQuery(form).ajaxSubmit({
                    success: function(responseText, statusText, xhr, $form) {
                        jQuery("#response").html(responseText).hide().slideDown("fast");
                        jQuery("#submit-contact").attr("value", "Trimite");
                    }
                });
                return false;
            }
